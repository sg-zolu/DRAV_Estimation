...
setwd("/Volumes/GEORGE_STORE/DRAV")
data <- read.csv("Vair_hypothesis_testing_0.03.csv")
...
setwd("/Volumes/GEORGE_STORE/DRAV")
df_Vair0.02 <- read.csv("Vair_hypothesis_testing_0.02.csv")
df_Vair0.03 <- read.csv("Vair_hypothesis_testing_0.03.csv")
df_Vair0.04 <- read.csv("Vair_hypothesis_testing_0.04.csv")
df_Vair0.05 <- read.csv("Vair_hypothesis_testing_0.05.csv")
...
df_stroke0.02 <- read.csv("stroke_Vair_analysis_0.02.csv")
df_stroke0.03 <- read.csv("stroke_Vair_analysis_0.03.csv")
df_stroke0.04 <- read.csv("stroke_Vair_analysis_0.04.csv")
df_stroke0.05 <- read.csv("stroke_Vair_analysis_0.05.csv")
